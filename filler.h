 ...
 */
    ...
    animation fill(FillerConfig &config);

// Add any helper functions here

    inline bool validCoordinates(unsigned int x, unsigned int y, unsigned int imageWidth, unsigned int imageHeight);
    inline bool withinToleranceDistance(HSLAPixel pixel, float tolerance, centre centre);
